...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "Depth of field with a rig that rings, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/gaffer/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/gaffer/";
